...
//            ThreeLittlePigs4_sub1(currentStep: $currentStep, isLeft: $isLeft) // 뷰 안그려짐이슈 해결을 위해 분리...
//                .onReceive(timer) { _ in
//                    isLeft.toggle()
//                }
//            
//            // 집을 선택하여 띄우는 뷰 - currentStep에 따라
//            ThreeLittlePigs4_sub2(currentStep: $currentStep, isLeft: $isLeft)
//                .onReceive(timer) { _ in
//                    isLeft.toggle()
//                }
//            
...
//
//// 캐릭터를 선택하여 띄우는 뷰 - currentStep에 따라
//struct ThreeLittlePigs4_sub1: View {
//    @Binding var currentStep: Int
...
//
//// 집을 선택하여 띄우는 뷰 - currentStep에 따라
//struct ThreeLittlePigs4_sub2: View {
//    @Binding var currentStep: Int
//    @Binding var isLeft: Bool
//    
//    var screenWidth = UIScreen.main.bounds.width
...
//            .animation(.easeInOut(duration: 0.5), value: isLeft)
//    }
//}
//
//#Preview {
